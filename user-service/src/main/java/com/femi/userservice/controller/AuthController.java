...
public class AuthController {
    ...
    @GetMapping("/validate")
    @Operation(summary = "Validate user token", description = "Validates JWT token and returns user details")
    ...
    public ResponseEntity<ApiResponseData<UserDTO>> validateToken(Authentication authentication) {

        log.info("Token validation request received for user: {}", authentication.getName());
